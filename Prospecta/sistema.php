	...
	<body>
		<div id="box">
			...
			<a   href="logout.php"><img src="img/logout.png" style="float:right; height:50px; width:50px"></a>
				<br><h1 style="color:white"> <a href="entrada.html" target="interno" class="titulo"> <p>Gestão Empresarial</p> </a></h1>
			...
			<br>
			<iframe name="interno" src="entrada.html" style="color:grey"> </iframe>
				<br> <br>
				<footer>
				</footer> 
